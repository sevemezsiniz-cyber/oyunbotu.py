...
def is_incoming_blocked(text: str) -> bool:
    """Hedef bot'tan gelen mesajda yasaklı ifade var mı? (Kullanıcı adı veya link)"""
    if not text:
        return True  # Boş mesajı da iletme
...
async def target_bot_handler(event):
    ...
    try:
        ...
        # === GELEN MESAJDA KULLANICI ADI VEYA LİNK VARSA İLETME ===
